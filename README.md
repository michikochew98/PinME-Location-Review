...
<h3 align="center">PinMe - Location Review Web</h3>

  <p align="center">
    It is a MERN web app that allow user to review on map location.
    <br />
...
4. Run npm run start at frontend dir and npm run start at backend dir to run project
  ```sh
  yarn start
  ```
...
## Usage
Click location icon to see review.
Double click to add review (Must register account first).
